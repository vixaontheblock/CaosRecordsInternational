...
export default function BookingCTA({ heading = "Start with a conversation.", copy = "Booking, management, artist inquiries, releases or partnerships — one inbox for the first step.", buttonLabel = "Get in touch", href = "/contact" }: { heading?: string; copy?: string; buttonLabel?: string; href?: string }) {
  return (
    <section className="bg-paper text-ink">
      <div className="max-w-content mx-auto px-5 sm:px-8 py-16 sm:py-20 lg:py-24 grid lg:grid-cols-[.72fr_.28fr] gap-12 items-end">
        <div>
          <p className="text-xs uppercase tracking-[.18em] text-ink/45">CAOS / Contact</p>
